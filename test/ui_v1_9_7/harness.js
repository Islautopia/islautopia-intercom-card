...
function makeHass() {
  return {
    ...
    // 1.9.7: el servicio se puede dejar colgado ('hang', para ver el chip optimista pendiente),
    // rechazar ('reject', como un HomeAssistantError de la integracion 0.7.4) o aceptar ('ok').
